...
TEST(AuthenticationFilesTest, LoadAuthenticationRequestFileAddHeaderFile)
{
    LoadAuthenticationRequestFile loadAuthenticationRequestFile("TEST_FILE.TEST", "A4");
    LoadAuthenticationRequestHeaderFile headerFile1;
...
TEST(AuthenticationFilesTest, LoadAuthenticationRequestFileSerialization)
{
    LoadAuthenticationRequestFile loadAuthenticationRequestFile("TEST_FILE.TEST", "A4");
    LoadAuthenticationRequestHeaderFile headerFile1;
    headerFile1.setHeaderFileName("TEST_FILE1.TEST");
...
TEST(AuthenticationFilesTest, LoadAuthenticationRequestFileSerializationOverflow)
{
    LoadAuthenticationRequestFile loadAuthenticationRequestFile("TEST_FILE.TEST", "A4");
    ...
    loadAuthenticationRequestFile.addHeaderFile(headerFile1);
    ...
    loadAuthenticationRequestFile.addHeaderFile(headerFile2);
...
TEST(AuthenticationFilesTest, LoadAuthenticationRequestFileDeserialization)
{
    std::shared_ptr<std::vector<uint8_t>> data = std::make_shared<std::vector<uint8_t>>();
    data->push_back(0);
    data->push_back(0);
    ...
    loadAuthenticationRequestFile.getProtocolVersion(protocolVersion);
...
TEST(AuthenticationFilesTest, LoadAuthenticationRequestFileSerializationJSON)
{
    LoadAuthenticationRequestFile loadAuthenticationRequestFile("TEST_FILE.TEST", "A4");
    LoadAuthenticationRequestHeaderFile headerFile1;
    headerFile1.setHeaderFileName("TEST_FILE1.TEST");
...
TEST(AuthenticationFilesTest, LoadAuthenticationRequestFileDeserializationJSON)
{
    std::string data("{"
                    "\"fileName\":\"TEST_FILE.TEST\","
                    "\"fileLength\":116,"
