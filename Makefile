...
# TARGET_NAME := libblsecurity.a libblsecurity.so
TARGET_NAME := libblsecurity.a
...
.PHONY: install
install:
	@echo "\n\n *** Installing BLSecutityManager to $(DESTDIR) *** \n\n"
